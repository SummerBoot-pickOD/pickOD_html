...
/*이용약관*/
termsOfUse = `제1조(목적)
이 약관은 서머부트 (이하 '회사' 라고 합니다)가 제공하는 제반 서비스의 이용과 관련하여 회사와 회원과의 권리, 의무 및 책임사항, 기타 필요한 사항을 규정함을 목적으로 합니다.
...
제4조(약관의 효력과 변경)
1. 이 약관은 서머부트(이)가 제공하는 모든 인터넷서비스에 게시하여 공시합니다.
'회사'는 ‘전자상거래 등에서의 소비자보호에 관한 법률(이하 '전자상거래법'이라 함)', '약관의 규제에 관한 법률(이하 '약관규제법'이라 함)', '전자문서 및 전자거래 기본법(이하 '전자문서법'이라 함)', ‘전자금융거래법 ‘, '정보통신망 이용촉진 및 정보보호 등에 관한 법률(이하 '정보통신망법'이라 함)',
 '소비자기본법' 등 관계 법령(이하 '관계법령' 이라 함)에 위배되지 않는 범위 내에서 이 약관을 변경할 수 있으며, 회사는 약관이 변경되는 경우에 변경된 약관의 내용과 시행일을 정하여, 그 시행일로부터 최소 7일 (이용자에게 불리하거나 중대한 사항의 변경은 30일) 이전부터 시행일 후 상당한 기간 동안 공지하고,
  기존 이용자에게는 변경된 약관, 적용일자 및 변경사유(변경될 내용 중 중요사항에 대한 설명을 포함)를 별도의 전자적 수단(전자우편, 문자메시지, 서비스 내 전자쪽지발송, 알림 메시지를 띄우는 등의 방법)으로 개별 통지합니다. 변경된 약관은 공지하거나 통지한 시행일로부터 효력이 발생합니다.
...
제8조(회원정보의 변경)
1. 회원은 개인정보관리(서비스명 회원정보수정)화면을 통하여 언제든지 본인의 개인정보를 열람하고 수정할 수 있습니다. 다만, 서비스 관리를 위해 필요한 실명, 아이디 등은 수정이 불가능합니다.
2. 제3자로부터 개인정보를 제공받은 경우, 생년월일 등 수정이 불가능한 정보가 늘어날 수 있습니다.
3. 회원은 회원가입신청 시 기재한 사항이 변경되었을 경우 온라인으로 수정을 하거나 전자우편 기타 방법으로 회사에 대하여 그 변경사항을 알려야 합니다.
4. 제2항의 변경사항을 회사에 알리지 않아 발생한 불이익은 회원에게 책임이 있습니다.
...
3. 회사는 대표자의 성명, 상호, 개인정보처리 담당자, 주소, 전화번호, 통신판매업 신고번호, 이용약관, 개인정보취급방침 등을 이용자가 쉽게 알 수 있도록 온라인 서비스 초기화면에 게시합니다.
...
2. 회사가 이용자의 개인정보의 보호 및 사용에 대해서 관련 법규 및 회사의 개인정보처리방침을 적용합니다. 다만, 회사에서 운영하는 웹 사이트 등에서 링크된 외부 웹페이지에서는 회사의 개인정보처리방침이 적용되지 않습니
...
1. 자신의 여행 후기(이하 여행일지) 작성 및 타인이 작성한 여행일지를 볼 수 있는 서비스
2. 여행 장소 및 행사/축제에 대한 정보를 볼 수 있는 서비스
3. 자신의 여행을 장소 단위로 계획할 수 있는 서비스
4. 개인 마이페이지 관리 서비스
...
5. 회사는 이용자가 본 약관에서 정한 이용자의 의무를 위반한 경우 등 비정상적인 이용 또는 부당한 이용과 이용자 금지프로그램 사용하는 경우 또는 타인의 명예를 훼손하거나 모욕하는 방송과 게시물을 작성한 경우 관리자의 승인을 거쳐 해당 사용자 ID에 이용제한(이하 제재)을 부과할 수 있으며, 제재 횟수에 따라 15일, 30일, 60일 이용제한을 부과할 수 있습니다.
...
2. 회사는 이용자가 본 약관에서 정한 이용자의 의무를 위반한 경우 등 비정상적인 이용 또는 부당한 이용과 이용자 금지프로그램 사용하는 경우 또는 타인의 명예를 훼손하거나 모욕하는 방송과 게시물을 작성한 경우 이때 제재 횟수가 4회 이상 누적되는 경우 이용자에게 통지하고, 계약을 해지할 수 있습니다.
...
1. 서비스 내에서 이용자가 작성한 콘텐츠의 복제, 수정, 전시, 전송, 배포 등 저작권을 침해하지 않는 범위 내의 2차적저작물 또는 편집 저작물 작성을 위한 사용. 다만, 해당 콘텐츠를 등록한 이용자가 해당 콘텐츠의 삭제 또는 사용 중지를 요청하는 경우 회사는 관련 법에 따라 보존해야하는 사항을 제외하고 관련 콘텐츠를 모두 삭제 또는 사용중지합니다.
...
제1조(시행일)
본 약관은 2024.10.16.부터 시행됩니다. `;

/*개인정보처리방침*/
privacyPolicy = `제1조(목적)
서머부트(이하 ‘회사'라고 함)는 회사가 제공하고자 하는 서비스(이하 ‘회사 서비스’)를 이용하는 개인(이하 ‘이용자’ 또는 ‘개인’)의 정보(이하 ‘개인정보’)를 보호하기 위해, 개인정보보호법, 정보통신망 이용촉진 및 정보보호 등에 관한 법률(이하 '정보통신망법') 등 관련 법령을 준수하고, 서비스 이용자의 개인정보 보호 관련한 고충을 신속하고 원활하게 처리할 수 있도록 하기 위하여 다음과 같이 개인정보처리방침(이하 ‘본 방침’)을 수립합니다.
...
1. 필수 수집 정보: 이메일 주소, 비밀번호, 닉네임 및 생년월일
2. 선택 수집 정보: 생일, 거주지 
...
부칙
제1조 본 방침은 2024.10.16.부터 시행됩니다.

`;



$("#terms-of-use>.textbox").val(termsOfUse);
$("#privacy-policy>.textbox").val(privacyPolicy);
